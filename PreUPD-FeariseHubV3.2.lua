...
local Window = Fluent:CreateWindow({
    Title = "Fearise Hub" .. " | ".."BlueLock : Rival".." | ".."[Version 3.2]",
    SubTitle = "By Zypher/Rex/Eyes",
    TabWidth = 160,
...
do
    ...
    -------------------------------------------------------[[ OP ]]-------------------------------------------------------
    local KaiserToggle = Tabs.pageOP:AddToggle("KaiserToggle", { Title = "Kaiser Impact", Default = getgenv().Settings.KaiserToggle or false })
    local KaiserKeybide = Tabs.pageOP:AddKeybind("KaiserKeybide", {
        Title = "Toggle Kaiser Impact Keybind",
        Mode = "Toggle",
        Default = "",
        Callback = function(Value)
    ...
    Function_Storage.CreateFeariseHubMobileToggle = function()
        ...
        kaiserImpack.Name = "KaiserImpact"
        ...
        buttonName1.Text = "Kaiser Impact"
